...
| `express-cookie-session-default-name` | `WARNING` | 쿠키 보안 속성(Secure/HttpOnly) 누출 우려가 있습니다. | `security/audit/express-cookie-settings.yaml` |
| `express-cookie-session-default-name` | `WARNING` | 쿠키 보안 속성(Secure/HttpOnly) 누출 우려가 있습니다. | `security/audit/express-cookie-settings.yaml` |
| `express-cookie-session-default-name` | `WARNING` | 쿠키 보안 속성(Secure/HttpOnly) 누출 우려가 있습니다. | `security/audit/express-cookie-settings.yaml` |
| `express-cookie-session-default-name` | `WARNING` | 쿠키 보안 속성(Secure/HttpOnly) 누출 우려가 있습니다. | `security/audit/express-cookie-settings.yaml` |
| `express-cookie-session-default-name` | `WARNING` | 쿠키 보안 속성(Secure/HttpOnly) 누출 우려가 있습니다. | `security/audit/express-cookie-settings.yaml` |
...
| `javascript-alert` | `WARNING` | 프로덕션 코드에 `prompt()` 호출이 남아있습니다. 배포 전 반드시 제거해 주세요. | `best-practice/leftover_debugging.yaml` |
| `javascript-alert` | `WARNING` | 프로덕션 코드에 `prompt()` 호출이 남아있습니다. 배포 전 반드시 제거해 주세요. | `best-practice/leftover_debugging.yaml` |
| `javascript-alert` | `WARNING` | 프로덕션 코드에 `prompt()` 호출이 남아있습니다. 배포 전 반드시 제거해 주세요. | `best-practice/leftover_debugging.yaml` |
| `javascript-alert` | `WARNING` | 프로덕션 코드에 `prompt()` 호출이 남아있습니다. 배포 전 반드시 제거해 주세요. | `best-practice/leftover_debugging.yaml` |
